...
func _physics_process(delta):
	...
	var scale_multiplier_z = self.player_size + (x_speed * scale_factor)
	var scale_multiplier_x = self.player_size - (x_speed * scale_factor)
	target_scale = Vector3(scale_multiplier_x, self.player_size, scale_multiplier_z)
